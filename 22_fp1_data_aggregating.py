...
full_lap_data=pd.read_csv("RAW_DATA/FP1_DATA/FP1_lap_data.csv")
...
final_fp1_data = final_fp1_data.merge(avg_sector_times, on=['RACEYEAR', 'RACENUMBER'], how="left")
...
final_fp1_data = final_fp1_data.merge(pit_summary, on=['RACEYEAR', 'RACENUMBER', 'Driver'], how="left")
