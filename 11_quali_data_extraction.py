...
os.makedirs("RAW_DATA/QUALI_DATA", exist_ok=True)  # Ensure output folder exists

# Enable FastF1 cache
fastf1.Cache.enable_cache("f1_cache")

# Define session types
session_types = ["Q"]  # Q for qualifying sessions
...
print("✅ All qualifying session data saved to CSV.")