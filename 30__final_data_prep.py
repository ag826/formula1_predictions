...
final_full_data.to_csv("PROCESSED_DATA/final_full_data.csv")

# ---------------------------------------------------------------------------------------------------------------- Only Free Practice Predictors

columns_to_drop = [
    "ClassifiedPosition","GridPosition","Time","Status","Points","WinnerTime","WinnerDriver","Racepace","RACE_AirTemp_mean","RACE_AirTemp_min","RACE_AirTemp_max","RACE_Humidity_mean","RACE_Humidity_min","RACE_Humidity_max","RACE_Pressure_mean","RACE_Pressure_min","RACE_Pressure_max","RACE_Rainfall_max","RACE_TrackTemp_mean","RACE_TrackTemp_min","RACE_TrackTemp_max","RACE_WindDirection_mean","RACE_WindSpeed_mean","RACE_WindSpeed_max","RACE_SESSIONTYPE_first","Driver_x","AvgPitStopDuration_ms","TotalPitStops","Driver_y","RACE_MaxStint_HARD","RACE_MaxStint_INTERMEDIATE","RACE_MaxStint_MEDIUM","RACE_MaxStint_SOFT","RACE_MaxStint_WET","RACE_AvgTyreLife_HARD","RACE_AvgTyreLife_INTERMEDIATE","RACE_AvgTyreLife_MEDIUM","RACE_AvgTyreLife_SOFT","RACE_AvgTyreLife_WET","RACE_AvgSpeedOnTyre_HARD","RACE_AvgSpeedOnTyre_INTERMEDIATE","RACE_AvgSpeedOnTyre_MEDIUM","RACE_AvgSpeedOnTyre_SOFT","RACE_AvgSpeedOnTyre_WET","RACE_AvgLapTimeOnTyre_HARD","RACE_AvgLapTimeOnTyre_INTERMEDIATE","RACE_AvgLapTimeOnTyre_MEDIUM","RACE_AvgLapTimeOnTyre_SOFT","RACE_AvgLapTimeOnTyre_WET","RACE_Red","RACE_SCDeployed","RACE_VSCDeployed","RACE_Yellow",
]
