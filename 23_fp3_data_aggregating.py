...
full_weather_data=pd.read_csv("FP3_DATA/FP3_weather_data.csv")
...
full_lap_data=pd.read_csv("FP3_DATA/FP3_lap_data.csv")
...
final_fp3_data=final_fp3_data.merge(pit_summary, left_on=['RACEYEAR', 'RACENUMBER'], right_on=['RACEYEAR', 'RACENUMBER'], how="right" )
...
track_status_data=pd.read_csv("FP3_DATA/FP3_track_status.csv")
...
final_fp3_data.to_csv("final_fp3_data.csv") 